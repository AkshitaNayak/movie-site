...
export default function Header() {
    return (
        <div className='w-full h-14 bg-violet-800 sticky'>
            <header className='flex flex-wrap items-center justify-between px-2 py-3'>
                <nav className='container px-4 mx-auto flex flex-wrap items-center justify-between'>
                    <div className=''>
                        <Link to="/">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 text-white -ml-16">
